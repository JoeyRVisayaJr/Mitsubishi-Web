...
function showContent(contentId) {
    window.localStorage.setItem('selectedContent', contentId);
}

function sendEmail() {

  var emailAddress = "@ryanjoybarreto@gmail.com";  // Replace with the recipient's email address
  var subject = "Inquiry about Outlander 2023";

  var body = "Good evening Mr. Ryan,\n\nI am [Your Name] and I want to inquire more about the Outlander 2023.";
